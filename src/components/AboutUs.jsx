        ...
        <div className="row mb-40">
          ...
          >
            ...
            <div className="about-content">
              <p>
                Welcome to IT Planet Software Solution, your trusted partner in
                digital transformation. Established with a vision to innovate and
                empower businesses with cutting-edge technology solutions, we specialize in
                providing a comprehensive suite of services tailored to meet your evolving needs.
              </p>
              <p>
                At IT Planet, we believe in harnessing the power of technology to drive
                business growth and enhance customer experiences. With a team of dedicated
                professionals and years of industry experience, we are committed to
