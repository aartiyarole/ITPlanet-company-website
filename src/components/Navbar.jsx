...
const Navbar = () => {
    ...
    return (
        <>
                            ...
                            <div className="sidebar-menu-wrap">
                                <ul className="main-menu">
                                    ...
                                    <li>
                                        ...
                                        <a>Services</a>
                                        <span className="dropdown-icon2" onClick={() => handleDropdown('services')}>
                                            <i className={`bi ${dropdowns.services ? 'bi-dash' : 'bi-plus'}`}></i>
                                        </span>
                                        
                                        <ul className={`submenu-list ${dropdowns.services ? 'active' : ''}`}>
                                            <li>
                                                <a>Website Development</a>
                                                <span className="dropdown-icon2" onClick={() => handleDropdown('webDevelopment')}>
                                                    <i className={`bi ${dropdowns.webDevelopment ? 'bi-dash' : 'bi-plus'}`}></i>
                                                </span>
                                                <ul className={`submenu-list ${dropdowns.webDevelopment ? 'active' : ''}`}>  {/* Add className binding here */}
                                                    <li>
                                            ...
                                            <li>
                                                ...
                                                <span className="dropdown-icon2" onClick={() => handleDropdown('videoProduction')}>
                                                    <i className={`bi ${dropdowns.videoProduction ? 'bi-dash' : 'bi-plus'}`}></i>
                                                </span>
                                                <ul  className={`submenu-list ${dropdowns.videoProduction ? 'active' : ''}`}>
                                                    <li>
                                                        <NavLink to="/shooting-services" >
                                                            Shooting
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">
                                                                <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                            </svg>
                                            ...
                                            <li>
                                                <a>Web Hosting</a>
                                                <span className="dropdown-icon2" onClick={() => handleDropdown('webHosting')}>
                                                    <i className={`bi ${dropdowns.webHosting ? 'bi-dash' : 'bi-plus'}`}></i>
                                                </span>
                                                <ul className={`submenu-list ${dropdowns.webHosting ? 'active' : ''}`}>
                                                    <li>
                                                        <NavLink to="/one-domain-hosting" >
                                                            One Domain Hosting
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">
                                                                <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                            </svg>
                                                    ...
                                                    <li>
                                                        <NavLink to="/multi-domain-hosting" >
                                    ...
                                    <li>
                                        <a>Courses</a>
                                        <span className="dropdown-icon2" onClick={() => handleDropdown('courses')}>
                                            <i className={`bi ${dropdowns.courses ? 'bi-dash' : 'bi-plus'}`}></i>
                                        </span>
                                        <ul className={`submenu-list ${dropdowns.courses ? 'active' : ''}`}>
                                            <li>
                                                <NavLink to="/courses/mern-stack" >
                                                    MERN Stack
                                                </NavLink>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <NavLink to="/courses/app-development" >
                                                    App Development
                                                </NavLink>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <NavLink to="/courses/digital-marketing" >
                                                    Digital Marketing
                                                </NavLink>
                                            </li>
                                        </ul>
                        ...
                        <div className="sidebar-contact">
                                    ...
                                    <ul>
                                        <li className="single-contact">
                                            ...
                                            <div className="contact">
                                                <span>Phone</span>
                                                <h6><a href="tel:+917774954303">+91 7774954303</a></h6>
                                            </div>
                                        </li>
                                        <li className="single-contact">
                                            <div className="icon">
                                ...
                                <div className="social-link-area">
                                    ...
                                    <ul className="social-area">
                                        <li><a href="https://dribbble.com/"><i className="bi bi-dribbble"></i> Dribbble</a></li>
                                        <li><a href="https://www.behance.net/"><i className="bi bi-behance"></i> Behance</a></li>
                                        <li><a href="https://www.pinterest.com/"><i className="bi bi-pinterest"></i> Pinterest</a></li>
            ...
            {/* Main Header */}
            <header className="header-area style-1 sticky">
                <div className="container d-flex flex-nowrap align-items-center justify-content-between">
                    ...
                    <div className="main-menu d-lg-flex d-none">
                        <ul className="menu-list">
                            <li className="menu-item-has-children">
                                <NavLink to="/" className={({isActive}) => isActive ? "drop-down active" : "drop-down"} end>
                                    Home
                                </NavLink>
                            </li>
                            <li className="menu-item-has-children">
                            ...
                            <li className="menu-item-has-children">
                                <a href="#" className="drop-down">
                                    Services
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="15" fill="currentColor" className="bi bi-chevron-down" viewBox="0 0 16 16">
                                        <path fillRule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                                    </svg>
                                </a>
                                <ul className="sub-menu">
                                    <li className="menu-item-has-children">
                                        <a href="#" className="drop-down">Website Development</a>
                                        <ul className="sub-menu">
                                            <li>
                                                <NavLink to="/website-development" className={({isActive}) => isActive ? "active" : ""}>
                                                    Professional Website Development
                                                </NavLink>
                                            </li>
                                            <li>
                                                <NavLink to="/ecommerce-development" className={({isActive}) => isActive ? "active" : ""}>
                                    ...
                                    <li>
                                        <NavLink to="/app-development" className={({isActive}) => isActive ? "active" : ""}>
                                            App Development
                                        </NavLink>
                                    </li>
                                    <li className="menu-item-has-children">
                                        ...
                                        <ul className="sub-menu">
                                            ...
                                            <li>
                                                <NavLink to="/editing-services" className={({isActive}) => isActive ? "active" : ""}>
                                                    Editing
                                                </NavLink>
                                            </li>
                                            <li>
                                                <NavLink to="/vfx-services" className={({isActive}) => isActive ? "active" : ""}>
                                                    VFX
                                                </NavLink>
                                            </li>
                                            <li>
                                                <NavLink to="/animation-services" className={({isActive}) => isActive ? "active" : ""}>
                                                    2D/3D Animation
                                                </NavLink>
                                            </li>
                                        </ul>
                                    ...
                                    <li className="menu-item-has-children">
                                        ...
                                        <ul className="sub-menu">
                                            ...
                                            <li>
                                                <NavLink to="/multi-domain-hosting" className={({isActive}) => isActive ? "active" : ""}>
                                                    Multi Domain Hosting
                                                </NavLink>
                                            </li>
                                        </ul>
                                    ...
                                    <li>
                                        <NavLink to="/digital-marketing" className={({isActive}) => isActive ? "active" : ""}>
                                            Digital Marketing
                                        </NavLink>
                                    </li>
                                    
                                    <li>
                                        <NavLink to="/graphic-designing" className={({isActive}) => isActive ? "active" : ""}>
                                            Graphic Designing
                                        </NavLink>
                                    </li>
                                    <li>
                                        <NavLink to="/printing-services" className={({isActive}) => isActive ? "active" : ""}>
                                            Printing Services
                                        </NavLink>
                                    </li>
                                </ul>
                            ...
                            <li className="menu-item-has-children">
                                ...
                                <ul className="sub-menu">
                                    <li>
                                        <NavLink to="/courses/mern-stack" className={({isActive}) => isActive ? "active" : ""}>
                                            MERN Stack
                                        </NavLink>
                                    </li>
                                    <li>
                                        <NavLink to="/courses/web-development" className={({isActive}) => isActive ? "active" : ""}>
                                            Website Development
                                        </NavLink>
                                    </li>
                                    <li>
                                        <NavLink to="/courses/reactjs" className={({isActive}) => isActive ? "active" : ""}>
                                            ReactJS/Native
                                        </NavLink>
                                    </li>
                                    <li>
                                        <NavLink to="/courses/app-development" className={({isActive}) => isActive ? "active" : ""}>
                                            App Development
                                        </NavLink>
                                    </li>
                                    <li>
                                        <NavLink to="/courses/graphic-designing" className={({isActive}) => isActive ? "active" : ""}>
                                            Graphic Designing
                                        </NavLink>
                                    </li>
                                    <li>
                                        <NavLink to="/courses/digital-marketing" className={({isActive}) => isActive ? "active" : ""}>
                                            Digital Marketing
                                        </NavLink>
                                    </li>
                                </ul>
                    ...
                    <div className="nav-right d-flex justify-content-end align-items-center">
                        <div className="sidebar-and-btn">
                            <div className="sidebar-btn d-lg-none" onClick={toggleSidebar}>
