...
startProgressbar();const text_type=document.querySelector('.text-type');if(text_type){var typing=new Typed(".text-type",{strings:["Digital Marketing","Email Marketing","SEO Optimization"],typeSpeed:120,backSpeed:70,loop:true,});}}(jQuery));
    ...
    if ($(".mouse-cursor")) {
        ...
        $("body").on(
                "mouseenter",
                "a,button,.know_tm_topbar .trigger, .cursor-pointer",
                function() {
            ...
            $("body").on(
                "mouseleave",
                "a,button,.know_tm_topbar .trigger,input[type='checkbox'],input[type='radio'],.cursor-pointer",
                function() {
